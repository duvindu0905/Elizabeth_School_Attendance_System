...
if(isset($_POST['save'])){
    ...
    if (!isValidClassName($className)) {
        $statusMsg = "<div class='alert alert-danger' style='margin-right:700px;'>Class Name must contain only letters!</div>";
    } else {
...
<head>
    ...
    <script>
        function validateForm() {
            ...
            if (!className.match(letters)) {
                alert("Class Name must contain only letters.");
                return false;
            }
                                    ...
                                    <form method="post" onsubmit="return validateForm();">
                                        <div class="form-group row mb-3">
                                            <div class="col-xl-6">
                                                ...
                                                <input type="text" class="form-control" name="className" id="className" value="<?php echo isset($row['className']) ? $row['className'] : ''; ?>" placeholder="Class Name">
                                            </div>
                                        </div>
                                        <?php
                                        if (isset($Id)) {
