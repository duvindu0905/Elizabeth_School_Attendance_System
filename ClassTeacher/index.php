...
// Fetch class and arm names for the dashboard header
...
$query = "SELECT last_login_time FROM tblclassteacher WHERE Id = '$userId'";
$rs = $conn->query($query);
$rows = $rs->fetch_assoc();
$lastLoginTime = $rows['last_login_time'];
    ...
    <div id="content-wrapper" class="d-flex flex-column">
      <div id="content">
        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row mb-3">
            <!-- Last Login Time Card -->
            <div class="col-xl-3 col-md-6 mb-4">
              <div class="card h-100">
                <div class="card-body">
                  <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                      <div class="text-xs font-weight-bold text-uppercase mb-1">Last Login Time</div>
                      <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $lastLoginTime; ?></div>
                    </div>
                    <div class="col-auto">
